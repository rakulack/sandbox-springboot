INSERT INTO user (email, password, roles, enable_flag) VALUES ('test@example.com', '{bcrypt}$2a$10$uhuqnvtjTayBhSjs7ezeB.2DG5GlIERAawzRoCROyTxWpzwKy7T.e', 'ROLE_USER,ROLE_ADMIN', 1);
INSERT INTO user (email, password, roles, enable_flag) VALUES ('test2@example.com', '{bcrypt}$2a$10$EQyVZTFajqzPEHVtmFXW2O7tq.czJbKO/Jf1EMYWziD26CaGzthTi', 'ROLE_USER', 1);
